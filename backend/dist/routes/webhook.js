 ...
 */
webhookRouter.post("/stripe", express.raw({ type: "application/json" }), async (req, res, next) => {
        ...
        try {
            ...
            const purchase = await db.transaction(async (tx) => {
                ...
                const [inserted] = await tx.insert(purchases).values({
                    ...
                    product: session.metadata?.product || "ebook-dzm-40",
