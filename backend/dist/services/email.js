...
export async function sendPurchaseEmail(data) {
    ...
    <body>
      <div class="container">
        ...
        <div class="social">
          <h3 style="color: #F5C542; margin-top: 30px; margin-bottom: 16px;">O que você recebe agora:</h3>
          <ul style="color: #B3B3B3; line-height: 2; padding-left: 20px;">
            <li>📖 Ebook "Do Zero ao Milhão" — PDF 40 páginas (design luxuoso preto e dourado)</li>
            <li>📊 Planilha de Controle Financeiro (bônus)</li>
            <li>✅ Checklist Mensal de Execução (bônus)</li>
            <li>🔄 Acesso vitalício + atualizações futuras</li>
            <li>🛡️ Garantia incondicional de 7 dias</li>
          </ul>
        ...
        <div class="footer">
          ...
          <p>© ${new Date().getFullYear()} Do Zero ao Milhão — Todos os direitos reservados</p>
        </div>
      </div>
    </body>
    </html>
